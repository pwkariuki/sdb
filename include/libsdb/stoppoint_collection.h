...
#ifndef SDB_STOPPOINT_COLLECTION_H
#define SDB_STOPPOINT_COLLECTION_H
...
namespace sdb {
    ...
    // Refers to a collection of breakpoint sites, watchpoints or breakpoints
...
#endif //SDB_STOPPOINT_COLLECTION_H
